#ifndef TRTS_SEGMENT_CSR_PLUGIN_H
#define TRTS_SEGMENT_CSR_PLUGIN_H
...
class SegmentCSRPlugin : public nvinfer1::IPluginV2DynamicExt
{
public:
    SegmentCSRPlugin() = delete;
    SegmentCSRPlugin(ReductionType reduce);
    SegmentCSRPlugin(const void* data, size_t length);
...
class SegmentCSRPluginCreator : public nvinfer1::IPluginCreator
{
public:
    SegmentCSRPluginCreator();
...
#endif // TRTS_SEGMENT_CSR_PLUGIN_H